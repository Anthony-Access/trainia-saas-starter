 ...
 *
 * ✅ REFACTORED: IP validation logic centralized in @/utils/ip-validation
 *
 ...
 *
 * ✅ REFACTORED: Now uses centralized implementation from @/utils/ip-validation
 *
 * This wrapper maintains backwards compatibility while delegating to the
 * centralized IP handling logic.
 *
 * @param request - The incoming request
 * @returns Client identifier (format: "IP:hash")
 */
export function getClientIdentifier(request: Request): string {
  return getClientIdentifierFromIP(request);
}
